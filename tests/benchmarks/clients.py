...
from evidence import REPO, RESOURCES, state_dir
...
#: Defines claude-local / codex-local. Generated by `ailocal sync`.
CLIENT_ENV = RESOURCES / "clients" / "configure.zsh"
...
PERMISSION_PREFLIGHT = (
    ("read", "Read the file profiles/clients.toml and reply with ONLY its first line."),
