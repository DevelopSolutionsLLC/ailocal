...
|---|---|---|---|
| `ailocal-architecture` | gemma4:26b-mlx | 98304 | 6h |
| `ailocal-implementation` | gemma4:26b-mlx | 73728 | -1 |
| `ailocal-review` | gemma4:26b-mlx | 69632 | -1 |
| `ailocal-fast` | qwen3.5:2b | 49152 | 20m |
| `ailocal-completion` | qwen2.5-coder:3b-instruct-q4_K_M | 4096 | 2h |
