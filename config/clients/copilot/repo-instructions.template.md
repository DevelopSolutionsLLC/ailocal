...
- `the generated config.yaml` — LiteLLM proxy config (generated by sync-models.py)
...
**Never hand-edit** `the generated config.yaml`, `config/clients/model_catalog.json`, or the
