...
|---|---|---|---|
| `ailocal-architecture` | qwen3-coder:30b-a3b-q4_K_M | 65536 | -1 |
| `ailocal-implementation` | qwen2.5-coder:14b-instruct-q4_K_M | 16384 | 20m |
| `ailocal-review` | gpt-oss:20b | 16384 | 20m |
| `ailocal-fast` | qwen3.5:2b | 32768 | 20m |
| `ailocal-completion` | qwen2.5-coder:3b-instruct-q4_K_M | 4096 | 20m |
| `ailocal-embeddings` | nomic-embed-text | 8192 | -1 |
