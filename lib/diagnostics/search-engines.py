...
settings.yml, so this cannot drift from what is actually loaded.
  ...
  lib/diagnostics/search-engines.py                 # safe default sweep
  lib/diagnostics/search-engines.py --extended      # adds the research query class
  lib/diagnostics/search-engines.py --engine arxiv  # one engine
  lib/diagnostics/search-engines.py --json          # machine-readable
