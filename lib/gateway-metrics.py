...
Usage:
    lib/gateway-metrics.py                       # from docker logs
    lib/gateway-metrics.py --since 30m
    lib/gateway-metrics.py --file captured.log
    lib/gateway-metrics.py --json               # machine-readable
"""
