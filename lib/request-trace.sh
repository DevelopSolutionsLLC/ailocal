...
#
#   ailocal trace              recent requests
#   ailocal trace --failures   only failures
#   ailocal trace --slow 5000  only requests slower than N ms
#   ailocal trace --id <id>    one request in full
#
