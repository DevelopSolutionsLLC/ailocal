...
# Usage: ailocal teardown [--images] [--clients]
#
...
#
#   ailocal teardown              # containers + volumes + network
#   ailocal teardown --images     # also remove all pulled Docker images
#   ailocal teardown --clients    # also uninstall claude-local/codex-local
