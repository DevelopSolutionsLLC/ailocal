...
This module owns the first two. scripts/diagnostics/verify-session.py owns the third and
...
class SessionObserver(CustomLogger):
    ...
    def build(self, data):
        ...
        return {
            ...
            # scripts/diagnostics/verify-session.py supplies it.
            "verdict": None,
            "verdict_note": "requires host-side filesystem/git comparison — "
                            "see scripts/diagnostics/verify-session.py",
        }
